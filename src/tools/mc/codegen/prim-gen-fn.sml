		...
		in
		  case cond
		   ...
		   (* 64-bit integer primitives *)
		    ...
		    | P.U64Lte a => genCmp (i64Ty, T.LEU, a)
		    | P.U64Gt a => genCmp (i64Ty, T.GTU, a)
		    | P.U64Gte a => genCmp (i64Ty, T.GEU, a)
		    | P.U64Eq a => genCmp (i64Ty, T.EQ, a)
		    | P.U64NEq a => genCmp (i64Ty, T.NE, a)
		  (* 32-bit floating-point *)
