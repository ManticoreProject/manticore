		...
		in
		  case p
		   ...
		   of P.I32Add a => genArith2 (i32Ty, T.ADD, a)
		    ...
		    | P.U32Mul a => genArith2 (i32Ty, T.MULU, a)
		    | P.U32Div a => genArith2 (i32Ty, T.DIVU, a)
		    | P.U32Rem a => genArith2 (i32Ty, T.REMU, a)
		    | P.I32AndB a => genArith2 (i32Ty, T.ANDB, a)
		    | P.I32OrB a => genArith2 (i32Ty, T.ORB, a)
		    | P.I32XorB a => genArith2 (i32Ty, T.XORB, a)
		    | P.I32NotB a => genArith1 (i32Ty, T.NOTB, a)
		   ...
		   (* 64-bit integer primitives *)
		    ...
		    | P.I64XorB a => genArith2 (i64Ty, T.XORB, a)
		    | P.I64NotB a => genArith1 (i64Ty, T.NOTB, a)
		  ...
		  (* conversions *)
			...
			val t = Cells.newReg ()
			in
			  T.MV (i64Ty, t, defOf x) ::
			  gprBind (i32Ty, v, T.REG (i32Ty, t))
			end
