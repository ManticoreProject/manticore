...
structure LLVMRuntime =
  ...
  in
    ...
    ***************************************)
    ...
    val ffiStack = mkConst "FFIStackFlag" LT.i32
    ...
    val linkedInvokeGC : LV.var * (LB.convention option) = (mkLabel "ASM_LinkedStack_InvokeGC" (retStructTyDS :: stdRegSetDS), SOME LB.jwaCC)
