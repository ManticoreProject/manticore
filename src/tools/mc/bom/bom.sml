...
structure BOM =
  struct
    ...
    (* concurrency operations *)
      | E_EnqueueSelf of var		(* enqueue the current thread *)
      | E_Enqueue of var * var		(* enqueue the current thread *)
      | E_EnqueueOn of var * var * var	(* enqueue a thread on a given vproc *)
      | E_Dequeue			(* dequeue a thread *)
