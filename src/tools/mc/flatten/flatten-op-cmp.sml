...
structure FlattenOpCmp : sig

  val typeOfOper : FlattenOps.oper -> Types.ty
  val same       : FlattenOps.oper * FlattenOps.oper -> bool
  val compare    : FlattenOps.oper * FlattenOps.oper -> order
