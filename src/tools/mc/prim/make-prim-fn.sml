  ...
  (* table mapping condition names to cond_info *)
    val findCond = let
	  ...
	  in
		...
		("U64Lte",      mk Cond2 (P.U64Lte,     (i64, i64))),
		("U64Gt",       mk Cond2 (P.U64Gt,      (i64, i64))),
		("U64Gte",      mk Cond2 (P.U64Gte,     (i64, i64))),
		("U64Eq",       mk Cond2 (P.U64Eq,      (i64, i64))),
		("U64NEq",      mk Cond2 (P.U64NEq,     (i64, i64))),
