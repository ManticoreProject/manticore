    ...
    val findPrim = let
	  ...
	  in
	    List.app (fn (n, info) => ins(Atom.atom n, info)) [
                ...
                ("U32Mul",      mk Prim2 (P.U32Mul,             (i32, i32),             i32)),
                ("U32Div",      mk Prim2 (P.U32Div,             (i32, i32),             i32)),
                ("U32Rem",      mk Prim2 (P.U32Rem,             (i32, i32),             i32)),
                ("I32AndB",     mk Prim2 (P.I32AndB,            (i32, i32),             i32)),
                ("I32OrB",      mk Prim2 (P.I32OrB,             (i32, i32),             i32)),
                ("I32XorB",     mk Prim2 (P.I32XorB,            (i32, i32),             i32)),
                ("I32NotB",     mk Prim1 (P.I32NotB,            i32,                    i32)),
...
*)
                ...
                ("I64XorB",     mk Prim2 (P.I64XorB,            (i64, i64),             i64)),
