  ...
  (* table mapping primop names to prim_info *)
    val findPrim = let
	  ...
	  in
		...
		("ArrayStoreI64", mk Prim3 (P.ArrayStoreI64,	(adrTy, i32, i64),	i32)),
		("ArrayStoreI32", mk Prim3 (P.ArrayStoreI32,	(adrTy, i32, i32),	i32)),
		("ArrayStoreF64", mk Prim3 (P.ArrayStoreF64,	(adrTy, i32, f64),	i32)),
		("ArrayStoreF32", mk Prim3 (P.ArrayStoreF32,	(adrTy, i32, f32),	i32)),
