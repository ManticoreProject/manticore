...
structure PrimUtil : sig
    ...
    fun nameOf (P.I32Add _) = "I32Add"
      ...
      | nameOf (P.U32Mul _) = "U32Mul"
      | nameOf (P.U32Div _) = "U32Div"
      | nameOf (P.U32Rem _) = "U32Rem"
      | nameOf (P.I32AndB _) = "I32AndB"
      | nameOf (P.I32OrB _) = "I32OrB"
      | nameOf (P.I32XorB _) = "I32XorB"
      | nameOf (P.I32NotB _) = "I32NotB"
  ...
  (* return the list of variables referenced in a primitive operation *)
    fun varsOf (P.I32Add(a, b)) = [a, b]
      ...
      | varsOf (P.I32Neg a) = [a]
      | varsOf (P.U32Mul(a, b)) = [a, b]
      | varsOf (P.U32Div(a, b)) = [a, b]
      | varsOf (P.U32Rem(a, b)) = [a, b]
      | varsOf (P.I32AndB(a, b)) = [a, b]
      | varsOf (P.I32OrB(a, b)) = [a, b]
      | varsOf (P.I32XorB(a, b)) = [a, b]
      | varsOf (P.I32NotB a) = [a]
    ...
    fun explode (P.I32Add(a, b)) = (p2 P.I32Add, [a, b])
      ...
      | explode (P.U32Mul(a, b)) = (p2 P.U32Mul, [a, b])
      | explode (P.U32Div(a, b)) = (p2 P.U32Div, [a, b])
      | explode (P.U32Rem(a, b)) = (p2 P.U32Rem, [a, b])
      | explode (P.I32AndB(a, b)) = (p2 P.I32AndB, [a, b])
      | explode (P.I32OrB(a, b)) = (p2 P.I32OrB, [a, b])
      | explode (P.I32XorB(a, b)) = (p2 P.I32XorB, [a, b])
      | explode (P.I32NotB a) = (p1 P.I32NotB, [a])
      ...
      | explode (P.I64XorB(a, b)) = (p2 P.I64XorB, [a, b])
