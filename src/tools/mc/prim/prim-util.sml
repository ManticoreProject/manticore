...
structure PrimUtil : sig
    ...
    fun nameOf (P.isBoxed _) = "isBoxed"
      ...
      | nameOf (P.I64ToAddr _) = "I64ToAddr"
      | nameOf (P.AddrAdd _) = "AddrAdd"
      | nameOf (P.AddrSub _) = "AddrSub"
      | nameOf (P.AddrLoadI8 _) = "AddrLoadI8"
      | nameOf (P.AddrLoadU8 _) = "AddrLoadU8"
      | nameOf (P.AddrLoadI16 _) = "AddrLoadI16"
      | nameOf (P.AddrLoadU16 _) = "AddrLoadU16"
      | nameOf (P.AddrLoadI32 _) = "AddrLoadI32"
      | nameOf (P.AddrLoadI64 _) = "AddrLoadI64"
      | nameOf (P.AddrLoadF32 _) = "AddrLoadF32"
      | nameOf (P.AddrLoadF64 _) = "AddrLoadF64"
      | nameOf (P.AddrLoad _) = "AddrLoad"
      | nameOf (P.AddrStoreI8 _) = "AddrStoreI8"
      | nameOf (P.AddrStoreI16 _) = "AddrStoreI16"
      | nameOf (P.AddrStoreI32 _) = "AddrStoreI32"
      | nameOf (P.AddrStoreI64 _) = "AddrStoreI64"
      | nameOf (P.AddrStoreF32 _) = "AddrStoreF32"
      | nameOf (P.AddrStoreF64 _) = "AddrStoreF64"
      | nameOf (P.AddrStore _) = "AddrStore"
  ...
  (* return the list of variables referenced in a primitive operation *)
    fun varsOf (P.isBoxed a) = [a]
      ...
      | varsOf (P.I64ToAddr a) = [a]
      | varsOf (P.AddrAdd (a, b)) = [a, b]
      | varsOf (P.AddrSub (a, b)) = [a, b]
      | varsOf (P.AddrLoadI8 a) = [a]
      | varsOf (P.AddrLoadU8 a) = [a]
      | varsOf (P.AddrLoadI16 a) = [a]
      | varsOf (P.AddrLoadU16 a) = [a]
      | varsOf (P.AddrLoadI32 a) = [a]
      | varsOf (P.AddrLoadI64 a) = [a]
      | varsOf (P.AddrLoadF32 a) = [a]
      | varsOf (P.AddrLoadF64 a) = [a]
      | varsOf (P.AddrLoad a) = [a]
      | varsOf (P.AddrStoreI8 (a, b)) = [a, b]
      | varsOf (P.AddrStoreI16 (a, b)) = [a, b]
      | varsOf (P.AddrStoreI32 (a, b)) = [a, b]
      | varsOf (P.AddrStoreI64 (a, b)) = [a, b]
      | varsOf (P.AddrStoreF32 (a, b)) = [a, b]
      | varsOf (P.AddrStoreF64 (a, b)) = [a, b]
      | varsOf (P.AddrStore (a, b)) = [a, b]
    ...
    fun explode (P.isBoxed a) = (p1 P.isBoxed, [a])
      ...
      | explode (P.I64ToAddr a) = (p1 P.I64ToAddr, [a])
      | explode (P.AddrAdd (a, b)) = (p2 P.AddrAdd, [a, b])
      | explode (P.AddrSub (a, b)) = (p2 P.AddrSub, [a, b])
      | explode (P.AddrLoadI8 a) = (p1 P.AddrLoadI8, [a])
      | explode (P.AddrLoadU8 a) = (p1 P.AddrLoadU8, [a])
      | explode (P.AddrLoadI16 a) = (p1 P.AddrLoadI16, [a])
      | explode (P.AddrLoadU16 a) = (p1 P.AddrLoadU16, [a])
      | explode (P.AddrLoadI32 a) = (p1 P.AddrLoadI32, [a])
      | explode (P.AddrLoadI64 a) = (p1 P.AddrLoadI64, [a])
      | explode (P.AddrLoadF32 a) = (p1 P.AddrLoadF32, [a])
      | explode (P.AddrLoadF64 a) = (p1 P.AddrLoadF64, [a])
      | explode (P.AddrLoad a) = (p1 P.AddrLoad, [a])
      | explode (P.AddrStoreI8 (a, b)) = (p2 P.AddrStoreI8, [a, b])
      | explode (P.AddrStoreI16 (a, b)) = (p2 P.AddrStoreI16, [a, b])
      | explode (P.AddrStoreI32 (a, b)) = (p2 P.AddrStoreI32, [a, b])
      | explode (P.AddrStoreI64 (a, b)) = (p2 P.AddrStoreI64, [a, b])
      | explode (P.AddrStoreF32 (a, b)) = (p2 P.AddrStoreF32, [a, b])
      | explode (P.AddrStoreF64 (a, b)) = (p2 P.AddrStoreF64, [a, b])
      | explode (P.AddrStore (a, b)) = (p2 P.AddrStore, [a, b])
    ...
    fun isPure (P.I32FetchAndAdd _) = false
      ...
      | isPure (P.AddrStoreI8 _) = false
      | isPure (P.AddrStoreI16 _) = false
      | isPure (P.AddrStoreI32 _) = false
      | isPure (P.AddrStoreI64 _) = false
      | isPure (P.AddrStoreF32 _) = false
      | isPure (P.AddrStoreF64 _) = false
      | isPure (P.AddrStore _) = false
