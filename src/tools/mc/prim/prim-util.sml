...
structure PrimUtil : sig
    ...
    fun nameOf (P.isBoxed _) = "isBoxed"
      ...
      | nameOf (P.ArrayLoadI32 _) = "ArrayLoadI32"
      | nameOf (P.ArrayLoadI64 _) = "ArrayLoadI64"
      | nameOf (P.ArrayLoadF32 _) = "ArrayLoadF32"
      | nameOf (P.ArrayLoadF64 _) = "ArrayLoadF64"
      | nameOf (P.ArrayLoad _) = "ArrayLoad"
      | nameOf (P.ArrayStoreI32 _) = "ArrayStoreI32"
      | nameOf (P.ArrayStoreI64 _) = "ArrayStoreI64"
      | nameOf (P.ArrayStoreF32 _) = "ArrayStoreF32"
      | nameOf (P.ArrayStoreF64 _) = "ArrayStoreF64"
      | nameOf (P.ArrayStore _) = "ArrayStore"
  ...
  (* return the list of variables referenced in a primitive operation *)
    fun varsOf (P.isBoxed a) = [a]
      ...
      | varsOf (P.ArrayLoadI32(a, b)) = [a, b]
      | varsOf (P.ArrayLoadI64(a, b)) = [a, b]
      | varsOf (P.ArrayLoadF32(a, b)) = [a, b]
      | varsOf (P.ArrayLoadF64(a, b)) = [a, b]
      | varsOf (P.ArrayLoad(a, b)) = [a, b]
      | varsOf (P.ArrayStoreI32(a, b, c)) = [a, b, c]
      | varsOf (P.ArrayStoreI64(a, b, c)) = [a, b, c]
      | varsOf (P.ArrayStoreF32(a, b, c)) = [a, b ,c]
      | varsOf (P.ArrayStoreF64(a, b, c)) = [a, b, c]
      | varsOf (P.ArrayStore(a, b, c)) = [a, b, c]
    ...
    fun explode (P.isBoxed a) = (p1 P.isBoxed, [a])
      ...
      | explode (P.ArrayLoadI32(a, b)) = (p2 P.ArrayLoadI32, [a, b])
      | explode (P.ArrayLoadI64(a, b)) = (p2 P.ArrayLoadI64, [a, b])
      | explode (P.ArrayLoadF32(a, b)) = (p2 P.ArrayLoadF32, [a, b])
      | explode (P.ArrayLoadF64(a, b)) = (p2 P.ArrayLoadF64, [a, b])
      | explode (P.ArrayLoad(a, b)) = (p2 P.ArrayLoad, [a, b])
      | explode (P.ArrayStoreI32(a, b, c)) = (p3 P.ArrayStoreI32, [a, b, c])
      | explode (P.ArrayStoreI64(a, b, c)) = (p3 P.ArrayStoreI64, [a, b, c])
      | explode (P.ArrayStoreF32(a, b, c)) = (p3 P.ArrayStoreF32, [a, b, c])
      | explode (P.ArrayStoreF64(a, b, c)) = (p3 P.ArrayStoreF64, [a, b, c])
      | explode (P.ArrayStore(a, b, c)) = (p3 P.ArrayStore, [a, b, c])
