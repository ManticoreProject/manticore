...
structure Prim =
  ...
  (* return the list of variables referenced in a primitive operation *)
    fun varsOf (BNot a) = [a]
      | varsOf (BEq(a, b)) = [a, b]
      | varsOf (BNEq(a, b)) = [a, b]
      | varsOf (I32Add(a, b)) = [a, b]
      | varsOf (I32Sub(a, b)) = [a, b]
      | varsOf (I32Mul(a, b)) = [a, b]
      | varsOf (I32Div(a, b)) = [a, b]
      | varsOf (I32Mod(a, b)) = [a, b]
      | varsOf (I32Neg a) = [a]
      | varsOf (I32Eq(a, b)) = [a, b]
      | varsOf (I32NEq(a, b)) = [a, b]
      | varsOf (I32Lt(a, b)) = [a, b]
      | varsOf (I32Lte(a, b)) = [a, b]
      | varsOf (I32Gt(a, b)) = [a, b]
      | varsOf (I32Gte(a, b)) = [a, b]
      | varsOf (I64Add(a, b)) = [a, b]
      | varsOf (I64Sub(a, b)) = [a, b]
      ...
      | varsOf (I64Lte(a, b)) = [a, b]
      | varsOf (I64Gt(a, b)) = [a, b]
      | varsOf (I64Gte(a, b)) = [a, b]
      | varsOf (F32Add(a, b)) = [a, b]
      | varsOf (F32Sub(a, b)) = [a, b]
      | varsOf (F32Mul(a, b)) = [a, b]
      | varsOf (F32Div(a, b)) = [a, b]
      | varsOf (F32Neg a) = [a]
      | varsOf (F32Eq(a, b)) = [a, b]
      | varsOf (F32NEq(a, b)) = [a, b]
      | varsOf (F32Lt(a, b)) = [a, b]
      | varsOf (F32Lte(a, b)) = [a, b]
      | varsOf (F32Gt(a, b)) = [a, b]
      | varsOf (F32Gte(a, b)) = [a, b]
      | varsOf (F64Add(a, b)) = [a, b]
      | varsOf (F64Sub(a, b)) = [a, b]
      | varsOf (F64Mul(a, b)) = [a, b]
      | varsOf (F64Div(a, b)) = [a, b]
      | varsOf (F64Neg a) = [a]
      | varsOf (F64Eq(a, b)) = [a, b]
      | varsOf (F64NEq(a, b)) = [a, b]
      | varsOf (F64Lt(a, b)) = [a, b]
      | varsOf (F64Lte(a, b)) = [a, b]
      | varsOf (F64Gt(a, b)) = [a, b]
      | varsOf (F64Gte(a, b)) = [a, b]
