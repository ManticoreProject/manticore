  ...
  (* the signature of a primop's arguments *)
    ...
    fun typeOf p = (case p
	   of P.isBoxed _ => bTy
	    ...
	    | P.I64ToF64 _ => f64Ty
	    | P.F64ToI32 _ => i32Ty
	    | P.I64ToAddr _ => Ty.addr anyTy
	    | P.AddrAdd _ => Ty.addr anyTy
	    | P.AddrSub _ => Ty.addr anyTy
	    | P.AddrLoadI8 _ => i8Ty
	    | P.AddrLoadU8 _ => i8Ty
	    | P.AddrLoadI16 _ => i16Ty
	    | P.AddrLoadU16 _ => i16Ty
	    | P.AddrLoadI32 _ => i32Ty
	    | P.AddrLoadI64 _ => i64Ty
	    | P.AddrLoadF32 _ => f32Ty
	    | P.AddrLoadF64 _ => f64Ty
	    | P.AddrLoad _ => anyTy
	    | P.AddrStoreI8 _ => Ty.noTy
	    | P.AddrStoreI16 _ => Ty.noTy
	    | P.AddrStoreI32 _ => Ty.noTy
	    | P.AddrStoreI64 _ => Ty.noTy
	    | P.AddrStoreF32 _ => Ty.noTy
	    | P.AddrStoreF64 _ => Ty.noTy
	    | P.AddrStore _ => Ty.noTy
    ...
    fun signOf p = (case p
	   of P.isBoxed _ => ([anyTy], bTy)
	    ...
	    | P.I64ToAddr _ => ([i64Ty], Ty.addr anyTy)
	    | P.AddrAdd _ => ([Ty.addr anyTy, Ty.addr anyTy], Ty.addr anyTy)
	    | P.AddrSub _ => ([Ty.addr anyTy, Ty.addr anyTy], Ty.addr anyTy)
(* FIXME: should AddrLoadI8, AddrLoadU8 and AddrStoreI8 take i32Ty's? *)
	    | P.AddrLoadI8 _ => ([Ty.addr i8Ty], i8Ty)
	    | P.AddrLoadU8 _ => ([Ty.addr i8Ty], i8Ty)
	    | P.AddrLoadI16 _ => ([Ty.addr i16Ty], i16Ty)
	    | P.AddrLoadU16 _ => ([Ty.addr i16Ty], i16Ty)
	    | P.AddrLoadI32 _ => ([Ty.addr i32Ty], i32Ty)
	    | P.AddrLoadI64 _ => ([Ty.addr i64Ty], i64Ty)
	    | P.AddrLoadF32 _ => ([Ty.addr f32Ty], f32Ty)
	    | P.AddrLoadF64 _ => ([Ty.addr f64Ty], f64Ty)
	    | P.AddrLoad _ => ([Ty.addr anyTy], anyTy)
	    | P.AddrStoreI8 _ => ([Ty.addr i8Ty, i8Ty], Ty.noTy)
	    | P.AddrStoreI16 _ => ([Ty.addr i16Ty, i16Ty], Ty.noTy)
	    | P.AddrStoreI32 _ => ([Ty.addr i32Ty, i32Ty], Ty.noTy)
	    | P.AddrStoreI64 _ => ([Ty.addr i64Ty, i64Ty], Ty.noTy)
	    | P.AddrStoreF32 _ => ([Ty.addr f32Ty, f32Ty], Ty.noTy)
	    | P.AddrStoreF64 _ => ([Ty.addr f64Ty, f64Ty], Ty.noTy)
	    | P.AddrStore _ => ([Ty.addr anyTy, anyTy], Ty.noTy)
