  ...
  (* the signature of a primop *)
    fun signOf p = (case p
	   of P.I32Add _ => ([i32Ty, i32Ty], i32Ty)
	    ...
	    | P.U32Mul _ => ([i32Ty, i32Ty], i32Ty)
	    | P.U32Div _ => ([i32Ty, i32Ty], i32Ty)
	    | P.U32Rem _ => ([i32Ty, i32Ty], i32Ty)
	    | P.I32AndB _ => ([i32Ty, i32Ty], i32Ty)
	    | P.I32OrB _ => ([i32Ty, i32Ty], i32Ty)
	    | P.I32XorB _ => ([i32Ty, i32Ty], i32Ty)
	    | P.I32NotB _ => ([i32Ty], i32Ty)
	    | P.I32LSh _ => ([i32Ty, i32Ty], i32Ty)
	    | P.I32RSh _ => ([i32Ty, i32Ty], i32Ty)
	    ...
	    | P.I64XorB _ => ([i64Ty, i64Ty], i64Ty)
	    | P.I64NotB _ => ([i64Ty], i64Ty)
	    | P.I64LSh _ => ([i64Ty, i64Ty], i64Ty)
	    | P.I64RSh _ => ([i64Ty, i64Ty], i64Ty)
	    ...
	    | P.I8RSh _ => ([i8Ty, i8Ty], i8Ty)
	    | P.I16RSh _ => ([i16Ty, i16Ty], i16Ty)
	    ...
	    | P.I32ToI16 _ => ([i32Ty], i16Ty)
	    | P.I16ToI8 _ => ([i16Ty], i8Ty)
