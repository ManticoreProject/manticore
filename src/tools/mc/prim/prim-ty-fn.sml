...
functor PrimTyFn (Ty : sig
    ...
    fun typeOf p = (case p
	   of P.isBoxed _ => bTy
	    ...
	    | P.ArrayLoadI32 _ => i64Ty
	    | P.ArrayStoreI32 _ => i32Ty (* should be Ty.unitTy *)
	    | P.ArrayLoadI64 _ => i32Ty
	    | P.ArrayStoreI64 _ => i32Ty (* should be Ty.unitTy *)
	    | P.ArrayLoadF32 _ => f32Ty
	    | P.ArrayStoreF32 _ => i32Ty (* should be Ty.unitTy *)
	    | P.ArrayLoadF64 _ => f64Ty
	    | P.ArrayStoreF64 _ => i32Ty (* should be Ty.unitTy *)
	    | P.BCAS _ => bTy
	    | P.TAS _ => bTy
	    | P.Pause => Ty.unitTy
