...
(* FIXME: this type should really be something like  void** -> void* *)
	    | P.AdrLoadAdr _ => ([Ty.addr anyTy], Ty.addr anyTy)
	    | P.AdrLoad _ => ([Ty.addr anyTy], anyTy)
...
(* FIXME: this type should really be something like  void** -> void* -> void *)
	    | P.AdrStoreAdr _ => ([Ty.addr anyTy, anyTy], Ty.noTy)
	    | P.AdrStore _ => ([Ty.addr anyTy, anyTy], Ty.noTy)
