...
val input =
   Trace.trace ("Instream.input", layout, (*String.layout*)Layout.str) input
...
val inputLine =
   Trace.trace ("Instream.inputLine", layout, MLtonOption.layout (*String.layout*)Layout.str) inputLine
