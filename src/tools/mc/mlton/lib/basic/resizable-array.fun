...
fun foldri (a, b, f) =
   (*Int.foldDown*)Int_foldDown (0, length a, b, fn (i, b) => f (i, unsafeSub (a, i), b))
...
val indices =
   Trace.trace ("Vector.indices", layout (*Bool.layout*)(Layout.str o Bool.toString), layout (*Int.layout*)Int_layout)
   indices
