...
val word = Trace.trace ("Random.word", Unit.layout, (*Word.layout*)Layout.str o Word.toString) word
...
val int = Trace.trace ("Random.int", Unit.layout, (*Int.layout*)Layout.str o Int.toString) int

local
val maxNat =
   let
      val shft = MLtonOption.fold (Int.precision, Word.wordSize, Int.min)
...
val nat = Trace.trace ("Random.nat", Unit.layout, (*Int.layout*)Layout.str o Int.toString) nat
...
val natReal = Trace.trace0 ("Random.natReal", (*Real.layout*)Layout.str o Real.toString) natReal
in
fun real () = scale (natReal () + scale (natReal ()))

val real = Trace.trace0 ("Random.real", (*Real.layout*)Layout.str o Real.toString) real
end
