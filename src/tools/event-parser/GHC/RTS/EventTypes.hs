...
--MANTICORE EVENTS
  | VProcStartIdle{}
  | VProcStart{vpId :: {-# UNPACK #-}!Word32}
  | VProcExit{vpId :: {-# UNPACK #-}!Word32}
  | VProcExitMain{}
  | VProcIdle{}
  | VProcSleep{}
  | VProcWakeup{}
  | PreemptVProc{vpid :: {-# UNPACK #-}!Word32}
  | PreemptSignal{}
  | GCSignal{sigid :: {-# UNPACK #-}!Word64}
  | MinorGCStart{nAllocBytes :: {-# UNPACK #-}!Word64}
  | MinorGCEnd{nCopiedBytes :: {-# UNPACK #-}!Word64, nAvailBytes :: {-# UNPACK #-}!Word64}
  | MajorGCStart{nYoungBytes :: {-# UNPACK #-}!Word64, nOldBytes :: {-# UNPACK #-}!Word64}
  | MajorGCEnd{nCopiedBytes :: {-# UNPACK #-}!Word64, nAvailBytes :: {-# UNPACK #-}!Word64}
  | GlobalGCInit{index :: {-# UNPACK #-}!Word64, uid :: {-# UNPACK #-}!Word64}
  | GlobalGCEnd{index :: {-# UNPACK #-}!Word64}
  | GlobalGCVPStart{}
  | GlobalGCVPDone{nbytes :: {-# UNPACK #-}!Word64}
  | PromoteStart{root :: {-# UNPACK #-}!Word64}
  | PromoteEnd{nbytes :: {-# UNPACK #-}!Word64}
  | ThdSpawn{threadID :: {-# UNPACK #-}!Word64}
  | ThdSpawnOn{threadID :: {-# UNPACK #-}!Word64}
  | ThdStart{threadID :: {-# UNPACK #-}!Word64}
  | ThdExit{}
  | MsgSendOffered{msgid :: {-# UNPACK #-}!Word64}
  | MsgSendResumed{mgid :: {-# UNPACK #-}!Word64}
  | MsgRecv{msgid :: {-# UNPACK #-}!Word64}
  | MsgRecvOffered{opid :: {-# UNPACK #-}!Word64}
  | MsgRecvResumed{msgid :: {-# UNPACK #-}!Word64, opid :: {-# UNPACK #-}!Word64}
  | MsgSend{msgid :: {-# UNPACK #-}!Word64, recvID :: {-# UNPACK #-}!Word64}
  | WSInit{wgid :: {-# UNPACK #-}!Word64}
  | WSTerminate{wgid :: {-# UNPACK #-}!Word64}
  | WSWorkerInit{wid :: {-# UNPACK #-}!Word64, wgid :: {-# UNPACK #-}!Word64}
  | WSExecute{wid :: {-# UNPACK #-}!Word64}
  | WSPreempted{wid :: {-# UNPACK #-}!Word64}
  | WSThiefSend{threadID :: {-# UNPACK #-}!Word64, wid :: {-# UNPACK #-}!Word64}
  | WSThiefBegin{threadID :: {-# UNPACK #-}!Word64, wid :: {-# UNPACK #-}!Word64}
  | WSThiefEnd{threadID :: {-# UNPACK #-}!Word64, wid :: {-# UNPACK #-}!Word64}
  | WSThiefSuccessful{threadID :: {-# UNPACK #-}!Word64, wid :: {-# UNPACK #-}!Word64}
  | WSThiefUnsuccessful{threadID :: {-# UNPACK #-}!Word64, wid :: {-# UNPACK #-}!Word64}
  | WSSleep{wid :: {-# UNPACK #-}!Word64}
  | RopeRebalanceBegin{ropeLen :: {-# UNPACK #-}!Word32}
  | RopeRebalanceEnd{ropeLen :: {-# UNPACK #-}!Word32}
--END MANTICORE EVENTS
